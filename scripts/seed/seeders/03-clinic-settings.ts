...
export async function seedClinicSettings(ctx: SeedContext): Promise<void> {
  const { doc } = await upsertOne(
    ...
    { clinicKey: CLINIC_SETTINGS_KEY },
    {
      ...
      clinicName: APP_NAME,
      address: {
        line1: "134, Kailashpuri Colony",
        line2: "Behind Khandaka Hospital, Tonk Road, Durgapura",
        city: "Jaipur",
        state: "Rajasthan",
        postalCode: "302018",
        country: DEFAULT_ADDRESS_COUNTRY,
      },
      phone: "+91 141 400 2000",
      secondaryPhone: "+91 98765 43210",
      email: "kratidentalcarejaipur@gmail.com",
      emergencyContact: "+91 141 400 2099",
      googleMapsUrl:
        "https://maps.google.com/?q=134+Kailashpuri+Colony+Tonk+Road+Durgapura+Jaipur",
      logoUrl: null,
      socialLinks: {
