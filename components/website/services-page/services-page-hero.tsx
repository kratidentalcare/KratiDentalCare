...
/**
 * Services page intro — breadcrumb, serif headline, short copy, book CTA.
 * Matches homepage typography tokens without reinventing the brand look.
 */
    ...
    >
      ...
      <PageContainer size="xl" className="relative public-section-y">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          <ServicesPageBreadcrumb className="mb-6 sm:mb-8" />
          ...
          >
            <span className="block">{SERVICES_PAGE.heading}</span>
            <span className="block text-brand-blue">
              {SERVICES_PAGE.headingAccent}
            </span>
          </h1>
