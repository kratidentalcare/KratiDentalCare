/**
 * Brand and app-level display constants (safe for client + server).
 */
...
/** Default clinic settings singleton key (v1 single-clinic). */
export const CLINIC_SETTINGS_KEY = "primary";
